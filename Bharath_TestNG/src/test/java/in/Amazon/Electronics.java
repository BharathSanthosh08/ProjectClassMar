...
import io.github.bonigarcia.wdm.WebDriverManager;
	...
	public class Electronics {
		...
		@org.testng.annotations.Test(priority = 1,groups = "default")
		...
		@org.testng.annotations.Test (priority = 2,groups = "sanity")
		...
		@org.testng.annotations.Test(priority = 3,groups = "sanity")
		public void MouseHoverToCameras() {
		WebElement Camera = driver.findElement(By.xpath("(//span[contains(text(),'Cameras')])[1]"));
		action.moveToElement (Camera).build().perform();
		} 
		@org.testng.annotations.Test(priority = 4,groups = "smoke",retryAnalyzer = retryAnalayzer.class)
		public void Validate_Listed_Options(String name,int x) {
		...
		Assert.assertEquals(expected,"bharath");
		...
		@org.testng.annotations.Test(priority = 5,groups = "smoke")
		public void Click_on_PhotoStudioLighting() {
		driver.findElement(By.xpath("//a[text()='Photo studio & lighting']/parent::li/a")).click();
	
		}
		@org.testng.annotations.Test(priority = 6,groups = "sanity")
